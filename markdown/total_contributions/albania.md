...
The `public contributions` and `private contributions` by users in Albania on `2024/1/27 10:14 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
...
<table>
	...
	<tr>
		<td>596</td>
		<td>
			<a href="https://github.com/ZwyklyLegionista">
				<img src="https://avatars.githubusercontent.com/u/137687720?s=72&u=5cfd42dd98957627928d99aba003a85b5ea70bed&v=4" width="24" alt="Avatar of ZwyklyLegionista"> ZwyklyLegionista
			</a><br/>
			ZwyklyLegionista
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>kurwidołek, Albania</td>
		<td>1</td>
		<td>1</td>
	</tr>
</table>
