...
The `number of followers` of users in Albania on `2023/12/5 10:15 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

There are `9 countries` and `68 cities` can be found [here](https://github.com/Masaku12/top-github-users).

There are `926 users`  in Albania. You need at least `0 followers` to be on this list.
